...
FAILURE_FILE = Path("evaluation/gale/gale_failures.json")
INDEX_PATH = Path("evaluation/gale/gale_failure.index")
META_PATH = Path("evaluation/gale/gale_failure_meta.npy")
