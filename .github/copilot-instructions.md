...
5. Keep logging consistent with existing structured event style; prefer pipe-separated key/value entries with spaces around pipes (for example: `event=LLM_SUCCESS | attempt=1 | sources=5`).
